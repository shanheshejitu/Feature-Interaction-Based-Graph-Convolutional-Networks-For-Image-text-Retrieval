...
class Net(nn.Module):
    def __init__(self, arg):
        ...
        self.Rs_GCN_3 = Rs_GCNM(in_channels=512, inter_channels=512)
        self.Rs_GCN_4 = Rs_GCNM(in_channels=512, inter_channels=512)
        self.Rs_GCN_5 = Rs_GCN(in_channels=512, inter_channels=512)
        self.Rs_GCN_6 = Rs_GCN(in_channels=512, inter_channels=512)
        self.Rs_GCN_7 = Rs_GCN(in_channels=512, inter_channels=512)
        self.Rs_GCN_8 = Rs_GCN(in_channels=512, inter_channels=512)
        self.Rs_GCN_9 = Rs_GCN(in_channels=512, inter_channels=512)
        self.Rs_GCN_10 = Rs_GCN(in_channels=512, inter_channels=512)
    ...
    def sim2(self, imgE, txtE, img_mask, txt_mask):
        ...
        imgE2,R_img = self.Rs_GCN_1(imgE1)
        txtE2,R_txt = self.Rs_GCN_2(txtE1)
        R_img1 = self.Rs_GCN_3(R_img, imgE2)
        R_txt1 = self.Rs_GCN_4(R_txt, txtE2)
        R_img2,_ = self.Rs_GCN_5(R_img1)
        R_txt2,_ = self.Rs_GCN_6(R_txt1)
        R_img3,_ = self.Rs_GCN_7(R_img2)
        R_txt3,_ = self.Rs_GCN_8(R_txt2)
        R_img4,_ = self.Rs_GCN_9(R_img3)
        R_txt4,_ = self.Rs_GCN_10(R_txt3)
