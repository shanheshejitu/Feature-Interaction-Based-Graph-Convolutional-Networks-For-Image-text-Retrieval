...
class Net(nn.Module):
    ...
    def sim2(self, imgE, txtE, img_mask, txt_mask):
        ...
        #imgE4 = self.Rs_GCN_5(imgE1)
        #txtE4 = self.Rs_GCN_6(txtE1)
        imgE4 = imgE1.unsqueeze(1).expand(-1, n_y, -1, -1)  # (n_x, n_y, n, d)
        txtE4 = txtE1.unsqueeze(0).expand(n_x, -1, -1, -1)  # (n_x, n_y, m, d)
